...
describe('Sleep', function() {
  ...
  it('should find the sleep hours for a user on a specified date', function() {
    expect(sleep.sleepLength(2, "2017/06/15")).to.equal(7);
    expect(sleep.sleepLength(4, "2019/06/21")).to.equal(6.1);
  });

  it('should find the sleep quality for a user on a specified date', function() {
    expect(sleep.sleepQuality(2, "2017/06/15")).to.equal(4.7);
    expect(sleep.sleepQuality(4, "2019/06/21")).to.equal(3.5);
  });
